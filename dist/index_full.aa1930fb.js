...
})({"94rBu":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "ff1b0294aa1930fb";
...
},{}],"lV9VM":[function(require,module,exports) {
...
const onLayoutsChanged = (layouts, selectedLayout)=>{
    if (layouts && layouts.length) {
        ...
        layouts.map((layout)=>{
            ...
            if (layout.layoutId === selectedLayout) item.classList = `${item.classList} selected`;
    ...
    if (variableList && variableList.length) {
        ...
        variableList.map((variable)=>{
            if (variable.type == "shorttext") {
                ...
                item.setAttribute("oninput", "setVariableValue('" + variable.id + "',this.value)");
                varContainer.appendChild(item);
            }
        });
    } else console.log("variables is empty");
};
window.setVariableValue = async (varid, value)=>{
    SDK.variable.setVariableValue(varid, value);
};
// Toggle Debug panel
        ...
        var __webpack_modules__ = {
            ...
            269: (__unused_webpack_module, __webpack_exports__, __webpack_require__)=>{
                ...
                __webpack_require__.r(__webpack_exports__), __webpack_require__.d(__webpack_exports__, {
                    ...
                    FontDownloadType: ()=>FontDownloadType,
                ...
                class FrameController {
                    constructor(editorAPI){
                        _FrameController_editorAPI.set(this, void 0), this.getFrames = ()=>__awaiter(this, void 0, void 0, function*() {
                                ...
                                return (yield __classPrivateFieldGet(this, _FrameController_editorAPI, "f")).reorderFrames(orderIndex, frameIdsToMove).then((result)=>getEditorResponseData(result));
                            }), this.setFrameZIndex = (frameId, method)=>__awaiter(this, void 0, void 0, function*() {
                                return (yield __classPrivateFieldGet(this, _FrameController_editorAPI, "f")).setFrameZIndex(frameId, method).then((result)=>getEditorResponseData(result));
                                ...
                                return (yield __classPrivateFieldGet(this, _FrameController_editorAPI, "f")).resetImageFrameFitMode(frameId).then((result)=>getEditorResponseData(result));
                                ...
                                return (yield __classPrivateFieldGet(this, _FrameController_editorAPI, "f")).assignImageFromUrl(imageFrameId, url).then((result)=>getEditorResponseData(result));
                            }), this.setImageFrameFitMode = (imageFrameId, fitMode)=>__awaiter(this, void 0, void 0, function*() {
                                return (yield __classPrivateFieldGet(this, _FrameController_editorAPI, "f")).setImageFrameFitMode(imageFrameId, fitMode).then((result)=>getEditorResponseData(result));
                ...
                class LayoutController {
                    constructor(editorAPI){
                        _LayoutController_editorAPI.set(this, void 0), _LayoutController_blobAPI.set(this, void 0), this.getLayouts = ()=>LayoutController_awaiter(this, void 0, void 0, function*() {
                            ...
                            }), this.getSelectedLayoutSnapshot = ()=>LayoutController_awaiter(this, void 0, void 0, function*() {
                ...
                class SubscriberController {
                    constructor(config){
                        ...
                        }, this.onConnectorStateChanged = (connectorEvent)=>{
                ...
                !function(FrameProperyNames) {
                    ...
                    DownloadFormats.MP4 = "mp4", DownloadFormats.GIF = "gif", DownloadFormats.PNG = "png", DownloadFormats.JPG = "jpg";
                }(DownloadFormats || (DownloadFormats = {}));
                ...
                var _ConfigurationController_editorAPI, DeprecatedMediaType, MediaType, SortBy, SortOrder, ConnectorRegistrationSource, ConnectorEventType, ConfigurationController_awaiter = function(thisArg, _arguments, P, generator) {
                    return new (P || (P = Promise))(function(resolve, reject) {
                        function fulfilled(value) {
                            try {
                                step(generator.next(value));
                ...
                }(ConnectorRegistrationSource || (ConnectorRegistrationSource = {})), function(ConnectorEventType) {
                    ConnectorEventType.loading = "loading", ConnectorEventType.loaded = "loaded", ConnectorEventType.unloaded = "unloaded", ConnectorEventType.running = "running", ConnectorEventType.ready = "ready", ConnectorEventType.reloaded = "reloaded", ConnectorEventType.error = "error";
                ...
                const package_namespaceObject_i8 = "0.84.2";
                ...
                class FontController {
                    constructor(editorAPI){
                        _FontController_editorAPI.set(this, void 0), this.getFonts = ()=>FontController_awaiter(this, void 0, void 0, function*() {
                            ...
                            }), this.getFontById = (fontId)=>FontController_awaiter(this, void 0, void 0, function*() {
                                return (yield FontController_classPrivateFieldGet(this, _FontController_editorAPI, "f")).getFontById(fontId).then((result)=>getEditorResponseData(result));
                            }), this.removeFont = (id)=>FontController_awaiter(this, void 0, void 0, function*() {
                                return (yield FontController_classPrivateFieldGet(this, _FontController_editorAPI, "f")).removeFont(id).then((result)=>getEditorResponseData(result));
                            }), this.addFont = (connectorId, font)=>FontController_awaiter(this, void 0, void 0, function*() {
                                return (yield FontController_classPrivateFieldGet(this, _FontController_editorAPI, "f")).addFont(connectorId, JSON.stringify(font)).then((result)=>getEditorResponseData(result));
                            }), this.isFontUsed = (fontKey)=>FontController_awaiter(this, void 0, void 0, function*() {
                                return (yield FontController_classPrivateFieldGet(this, _FontController_editorAPI, "f")).isFontUsed(fontKey).then((result)=>getEditorResponseData(result));
                ...
                class ConnectorController {
                    constructor(editorAPI){
                        _ConnectorController_editorAPI.set(this, void 0), this.registerConnector = (registration)=>ConnectorController_awaiter(this, void 0, void 0, function*() {
                            ...
                            }), this.configure = (connectorId, configurationCallback)=>ConnectorController_awaiter(this, void 0, void 0, function*() {
                                const res = yield ConnectorController_classPrivateFieldGet(this, _ConnectorController_editorAPI, "f");
                                return yield this.waitForConnectorReady(connectorId), yield configurationCallback(new ConnectorConfigurator(connectorId, res)), res.updateConnectorConfiguration(connectorId).then((result)=>getEditorResponseData(result));
                            }), this.getState = (connectorId)=>ConnectorController_awaiter(this, void 0, void 0, function*() {
                                return (yield ConnectorController_classPrivateFieldGet(this, _ConnectorController_editorAPI, "f")).getConnectorState(connectorId).then((result)=>getEditorResponseData(result));
                            }), this.waitForConnectorReady = (connectorId, timeoutMilliseconds = 2e3)=>ConnectorController_awaiter(this, void 0, void 0, function*() {
                                let timeout = Math.max(timeoutMilliseconds, 500);
                                timeout = Math.min(timeout, 5e3);
                                let retries = 0;
                                try {
                                    for(; 100 * retries < timeout;){
                                        const result = yield this.getState(connectorId);
                                        if (result.success && result.parsedData && result.parsedData.type !== ConnectorEventType.error && result.parsedData.type !== ConnectorEventType.loading) return getEditorResponseData({
                                            data: null,
                                            success: !0,
                                            error: void 0,
                                            status: 0,
                ...
                class ConnectorConfigurator {
                    constructor(connectorId, res){
                        _ConnectorConfigurator_connectorId.set(this, void 0), _ConnectorConfigurator_res.set(this, void 0), this.setChiliToken = (token)=>ConnectorController_awaiter(this, void 0, void 0, function*() {
                            ...
                            }), this.setHttpHeader = (headerName, headerValue)=>ConnectorController_awaiter(this, void 0, void 0, function*() {
                            ...
                            }), ConnectorController_classPrivateFieldSet(this, _ConnectorConfigurator_connectorId, connectorId, "f"), ConnectorController_classPrivateFieldSet(this, _ConnectorConfigurator_res, res, "f");
                    }
                }
                ...
                var _ExperimentController_editorAPI, SlideDirections, ShakeDirections, EaseTypes, TweenTypes, BasicAnimationsEmphasisStyles, LayoutType, FrameTypeEnum, TextDirection, FlowDirection, VerticalAlign, BlendMode, FitMode, UpdateZIndexMethod, VariableType, ColorUsageType, FontWeights, Alignment, TextPosition, Case, Scripting, SelectedTextStyleSections, SelectedTextStyles, BlendModes, ColorType, MediaDownloadType, FontDownloadType, ExperimentController_awaiter = function(thisArg, _arguments, P, generator) {
                    return new (P || (P = Promise))(function(resolve, reject) {
                        function fulfilled(value) {
                            try {
                                step(generator.next(value));
                ...
                class ExperimentController {
                    constructor(editorAPI){
                        _ExperimentController_editorAPI.set(this, void 0), this.insertTextVariable = (variableId)=>ExperimentController_awaiter(this, void 0, void 0, function*() {
                                return (yield ExperimentController_classPrivateFieldGet(this, _ExperimentController_editorAPI, "f")).insertTextVariable(variableId).then((result)=>getEditorResponseData(result));
                            }), ExperimentController_classPrivateFieldSet(this, _ExperimentController_editorAPI, editorAPI, "f");
                    }
                }
                let connection;
                _ExperimentController_editorAPI = new WeakMap, function(SlideDirections) {
                ...
                }(FitMode || (FitMode = {})), function(UpdateZIndexMethod) {
                    UpdateZIndexMethod.bringToFront = "bringToFront", UpdateZIndexMethod.sendToBack = "sendToBack", UpdateZIndexMethod.bringForward = "bringForward", UpdateZIndexMethod.sendBackward = "sendBackward";
                }(UpdateZIndexMethod || (UpdateZIndexMethod = {})), function(VariableType) {
                ...
                }(MediaDownloadType || (MediaDownloadType = {})), function(FontDownloadType) {
                    FontDownloadType.Preview = "lowresWeb", FontDownloadType.Download = "outputPdf";
                }(FontDownloadType || (FontDownloadType = {}));
                class SDK {
                    constructor(config){
                        this.loadEditor = ()=>{
                            connector(this.config.editorLink || "https://studio-cdn.chiligrafx.com/editor/0.0.15/web", {
...
},{}]},["94rBu","lV9VM"], "lV9VM", "parcelRequire94c2")

//# sourceMappingURL=index_full.aa1930fb.js.map
